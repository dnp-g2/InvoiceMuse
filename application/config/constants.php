...
/*
|--------------------------------------------------------------------------
| InvoiceMuse release version
|--------------------------------------------------------------------------
|
| The released InvoiceMuse version, kept in step with package.json and the
| release tag. The database schema version comes from the setup/sql migration
