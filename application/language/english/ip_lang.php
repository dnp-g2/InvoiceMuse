...
$lang = [
    ...
    'bcc_mails_to_admin_hint'                       => 'The admin account is the account that was created while installing InvoiceMuse.',
    ...
    'custom_templates_upgrade_required_docs'        => 'For upgrade instructions, read <a href="https://github.com/dnp-g2/InvoiceMuse/blob/main/.github/docs/UPGRADE.md" target="_blank" rel="noopener">UPGRADE.md</a> and <a href="https://github.com/dnp-g2/InvoiceMuse/blob/main/.github/docs/MIGRATION_GUIDE_v1.7.2.md" target="_blank" rel="noopener">MIGRATION_GUIDE_v1.7.2.md</a>.',
    ...
    'custom_templates_upgrade_required_message'     => 'InvoiceMuse does not discover custom templates from the filesystem. These saved template settings are not in the current custom template allowlist and may disappear from the template selectors after upgrading:',
    ...
    'invoice_templates_info'                        => 'You can extend the available templates by downloading other templates provided by the InvoicePlane community (see <a href="https://www.invoiceplane.com/themes" target="_blank">www.invoiceplane.com/themes</a>).',
    'invoice_terms'                                 => 'Invoice Terms',
    'invoiced'                                      => 'Invoiced',
    'invoiceplane_news'                             => 'InvoiceMuse News',
    'invoices'                                      => 'Invoices',
    ...
    'password_reset_email'                          => 'You requested a new password for your installation of InvoiceMuse. Please click the following link to reset your password:',
    ...
    'php_version_fail'                              => 'PHP version %s is installed but InvoiceMuse requires PHP version %s or higher',
    'php_version_success'                           => 'PHP appears to meet the installation requirement',
    'please_enable_js'                              => 'Please enable Javascript to use InvoiceMuse',
    ...
    'price'                                         => 'Price',
    'product'                                       => 'Product',
    'product_credit'                                => 'InvoiceMuse is based on <a href="https://www.invoiceplane.com/" target="_blank" rel="noopener noreferrer">InvoicePlane</a>. Thank you to its developers and contributors.',
    ...
    'setup_complete_message'                        => 'InvoiceMuse has been successfully installed. You may now log in.',
    ...
    'setup_complete_support_note'                   => 'If you encounter any problems or need help, the <a href="https://wiki.invoiceplane.com">InvoicePlane wiki</a> and <a href="https://community.invoiceplane.com/">InvoicePlane community forum</a> also apply to InvoiceMuse.',
    'setup_create_user'                             => 'Create User Account',
    'setup_create_user_message'                     => 'This is the information you will need to log into InvoiceMuse.',
    ...
    'setup_db_database_info'                        => 'The name of the database you created for InvoiceMuse.',
    ...
    'setup_prerequisites_message'                   => 'Welcome to InvoiceMuse! Any issue listed below must be resolved before the installation can continue.',
    ...
    'setup_user_email_info'                         => 'Your Email address will be used to log into InvoiceMuse.',
    ...
    'setup_v120_alert'                              => '<strong>Attention!</strong><br>It\'s very important that you read <a href="https://go.invoiceplane.com/v120update" target="_blank">this update notice</a> about some significant changes in version 1.2.0.',
    ...
    'updatecheck_not_configured'                    => 'Automatic InvoiceMuse update checks are not configured. Check the release source used to install this application before upgrading.',
    'updates'                                       => 'Updates',
...
// Invoice workspace
$lang += [
    'invoice_workspace_back' => 'Back to invoices',
    'invoice_workspace_save' => 'Save changes',
    'invoice_workspace_record_payment' => 'Record payment',
    'invoice_workspace_send' => 'Send invoice',
    'invoice_workspace_more' => 'More actions',
    'invoice_workspace_copy_link' => 'Copy customer link',
    'invoice_workspace_preview' => 'Preview draft',
    'invoice_workspace_copy_draft' => 'Copy to new draft',
    'invoice_workspace_bill_to' => 'Bill to',
    'invoice_workspace_contact' => 'Contact details',
    'invoice_workspace_charges' => 'Charges',
    'invoice_workspace_manage_properties' => 'Manage properties',
    'invoice_workspace_locked' => 'Service addresses are saved with this invoice. Copy to a new draft to change them.',
    'invoice_workspace_copy_help' => 'Return to summary to copy.',
    'invoice_workspace_add_property' => 'Add property',
    'invoice_workspace_choose_property' => 'Choose a property',
    'invoice_workspace_attachments_help' => 'Save or cancel your changes before managing attachments.',
    'invoice_workspace_manage_attachments' => 'Manage attachments',
    'invoice_workspace_balance_due' => 'Balance due',
    'invoice_workspace_totals_pending' => 'Last saved totals. Save changes to update amounts.',
    'invoice_workspace_included' => 'Included in subtotal',
    'invoice_workspace_save_help' => 'Changes are saved only when you choose Save changes.',
    'invoice_workspace_empty' => 'No charges yet. Edit this invoice to add the work you are billing for.',
    'invoice_workspace_service_property' => 'Service property',
    'invoice_workspace_service' => 'Service',
    'invoice_workspace_rate' => 'Rate',
    'invoice_workspace_charges_total' => 'Charges total',
    'invoice_workspace_charge_details' => 'Charge details',
    'invoice_workspace_row_actions' => 'Charge actions',
    'invoice_workspace_remove' => 'Remove',
    'invoice_workspace_change_property' => 'Move to property',
    'invoice_workspace_archived' => 'Archived',
    'invoice_workspace_saved_total' => 'Last saved total',
    'invoice_workspace_additional' => 'Additional settings',
    'invoice_workspace_refresh' => 'Refresh saved billing and service addresses on next save',
    'invoice_workspace_add_charge' => 'Add charge',
    'invoice_workspace_add_from' => 'Add from…',
    'invoice_workspace_unassigned' => 'Choose a property for these charges',
    'invoice_workspace_assign' => 'Assign charges',
    'invoice_workspace_discard' => 'Discard unsaved changes?',
    'invoice_workspace_saving' => 'Saving…',
    'invoice_workspace_saved' => 'Changes saved.',
    'invoice_workspace_network_error' => 'The save could not be confirmed. Your entries are still here. Reload and review the invoice before trying again.',
    'invoice_workspace_save_error' => 'Please correct the highlighted fields and save again.',
    'invoice_workspace_copied' => 'Customer link copied.',
    'invoice_workspace_copy_error' => 'Unable to copy the link. Try again in your browser.',
    'invoice_workspace_removed' => 'Charge removed from this edit. Save changes to apply, or Cancel to keep it.',
    'invoice_workspace_pick_first' => 'Choose a property first.',
    'invoice_workspace_view_saved' => 'View saved invoice',
    'invoice_workspace_saved_changes' => 'Changes saved.',
    'invoice_workspace_pending' => 'Unsaved changes',
    'invoice_workspace_tax_remove' => 'Remove this invoice tax?',
    'invoice_workspace_loading_failed' => 'Unable to load this action. Please try again.',
];

$lang['invoice_workspace_no_attachments'] = 'No attachments yet.';
