...
// Deployment gate: CLI migrations remain available while HTTP requests receive a retryable response.
if (PHP_SAPI !== 'cli' && is_file(__DIR__ . '/application/config/.service-properties-maintenance')) {
    http_response_code(503);
    header('Retry-After: 60');
    header('Content-Type: text/plain; charset=UTF-8');
    exit('Brief maintenance in progress. Please retry in a minute.');
}
